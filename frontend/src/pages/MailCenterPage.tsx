...
export function MailCenterPage() {
  ...
  return <>
    ...
    <section className="grid h-[calc(100vh-10rem)] min-h-[38rem] overflow-hidden rounded-xl border bg-white xl:grid-cols-[12rem_minmax(19rem,0.85fr)_minmax(38rem,1.7fr)]">
