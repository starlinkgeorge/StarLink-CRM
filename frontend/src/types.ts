...
export interface OrderProfitAnalytics { period:OrderProfitPeriod; selected_summary:OrderProfitSummary; period_summaries:OrderProfitSummary[]; monthly_trend:OrderProfitTrendPoint[]; customer_ranking:OrderProfitCustomerRank[]; }
