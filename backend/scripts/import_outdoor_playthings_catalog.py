...
PRODUCTS = [
    ...
    ("Nature & Planting", "ZZ-04", "Root Observation Box", "370.00", "96 x 48 x 120 cm", WOOD_MATERIAL, None),
    ...
    ("Outdoor Art & Creative", "YS-04", "Double-sided Drawing Board", "529.00", "100 x 98 x 87 cm", WOOD_MATERIAL, None),
    ...
    ("Outdoor Living", "HW-02", "Spliced Dining Table", "999.00", "115 x 35 x 60 cm, 6-piece set", WOOD_MATERIAL, None),
    ...
    ("Outdoor Living", "HW-04", "Barbecue Grill", "397.00", "130 x 57 x 155 cm", WOOD_MATERIAL, None),
